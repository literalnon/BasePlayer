...
import com.example.donald.testapp.ListAdapter;
...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView listView = (ListView) mainView.findViewById(R.id.listItem);
        listView.setAdapter(new ListAdapter(context, presenter));
    ...
    public void onAttach(Context context) {
        ...
        presenter = (Presenter)((MainView)context).getPresenter();
